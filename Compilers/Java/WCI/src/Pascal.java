...
public class Pascal {
	...
	private SymTabStack symTabStack;// Generated symbol table stack
	...
	public Pascal(String operation, String filePath, String flags)
	{
		try {
			...
			symTabStack = parser.getSymStack();
	...
	/**
	 * The main method.
	 * @param args command-line arguments: "compile" or "execute" followed
	 * by optional flags followed by source path.
	 */
		...
		public void messageReceived(Message message)
		{
			...
			switch(type) {
				...
				case SYNTAX_ERROR: {
					...
					// A pointer to the error followed by error message
					flagBuffer.append("^\n*** ").append(errorMessage);
					
					// Text, if any, of incorrect token
					if (tokenText != null) {
